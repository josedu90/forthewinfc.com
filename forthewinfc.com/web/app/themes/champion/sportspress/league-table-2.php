...
$output .= '<table class="sp-league-table sp-data-table' . ( $responsive ? ' sp-responsive-table' : '' ) . ( $sortable ? ' sp-sortable-table' : '' ) . ( $paginated ? ' sp-paginated-table' : '' ) . '" data-sp-rows="' . esc_attr( $rows ) . '">' . '<thead>' . '<tr>';
...
if ( $show_full_table_link )
	$output .= '<a class="sp-league-table-link sp-view-all-link" href="' . esc_url( get_permalink( $id ) ) . '">' . __( 'View full table', 'sportspress' ) . '</a>';

?>
<div class="sp-template sp-template-league-table">
	<?php echo balanceTags( $output, true ); ?>
</div>